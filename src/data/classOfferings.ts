...
export const CLASSES_DATA: ClassOffering[] = [
  ...
  },
  {
    ...
    description:
      "Get the maximum opportunity for tailored feedback in weekly, one-on-one private coaching, helping you get into your school's debating teams, win more debates and sharpen your speaking.",
  },
];
